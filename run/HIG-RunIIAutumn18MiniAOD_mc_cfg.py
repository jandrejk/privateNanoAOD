...
manual_JEC = False
GT = "102X_upgrade2018_realistic_v18" #2019-04-08
sync_2018_file = '/afs/hephy.at/work/j/jandrejkovic/privateNanoAOD/CMSSW_10_2_14/src/run/VBF_upgrade2018.root'
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:{0}'.format(sync_2018_file)),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:{0}'.format(output_name)),
